package com.scasistemas.msimagens.application.dto.produto;
...
public class ProdutoResponse {
    ...
    @Schema(description = "Imagens do produto com status e URL da Cloudflare. "
            + "Populado apenas nas operações de criação e atualização com upload.")
