...
class JwtAuthenticationFilterTest {
    ...
    void deveAutenticarComTokenValido() throws ServletException, IOException {
        ...
        com.scasistemas.msbluedot.domain.entities.Usuario usuario = com.scasistemas.msbluedot.domain.entities.Usuario
                .builder()
                .id(1L).nome("admin")
                .role(com.scasistemas.msbluedot.domain.enums.RoleEnum.ADMINISTRADOR)
